...
Submission.belongsTo(User, { foreignKey: "student_id", as: "student" });
  ...
  // Assessment & Questions/Submissions
  ...
  // FIX: Grade nối với Submission (Theo DDL)
